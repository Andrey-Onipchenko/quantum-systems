...
if (document.querySelector("#numberTop")) {
  ...
  intl_tel_input__WEBPACK_IMPORTED_MODULE_1___default()(inputTop, {
    initialCountry: "ua",
  });
}
if (document.querySelector("#numberBottom")) {
  const inputBottom = document.querySelector("#numberBottom");
  intl_tel_input__WEBPACK_IMPORTED_MODULE_1___default()(inputBottom, {
    initialCountry: "ua",
  });
}

if (document.querySelector('[data-counter="counter"]')) {
  const counter = new _counter__WEBPACK_IMPORTED_MODULE_0__.default('[data-counter="counter"]', 170, 10, 5000);
}
if (document.querySelector('[data-counter="counter-peoples"]')) {
  const counterPeoples = new _counter__WEBPACK_IMPORTED_MODULE_0__.default(
